<div class="row">
    <div class="col-xs-12 col-md-offset-2 col-md-6">
        <h3 class="page-header">Editando Tipo de Documento N°<?= $tdocumento->tdoc_cod ?></h3>
    </div>
    <div class="col-xs-12 col-md-offset-2 col-md-6">
        <?php if(isset($result)):?>
...
<div class="row">
    <div class="col-xs-12 col-md-offset-2 col-md-6">
        <form enctype="multipart/form-data" class="form-horizontal" action="<?=site_url(array('tdocumento', 'update', $tdocumento->tdoc_cod))?>" method="post">
            ...
            <div class="col-xs-12">
                <div class="form-group input-group">
                    ...
                    <input letters="true" required="required" class="form-control" type="text" 
                     name="tdoc_nombre" value="<?=$tdocumento->tdoc_nombre?>">
                </div>
            </div>
