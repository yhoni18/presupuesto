<?php
/**
 * PHPMailer - PHP correo transport unit tests
...
/**
 * PHPMailer - PHP correo transport unit test class
...
class PHPMailerTest extends PHPUnit_Framework_TestCase
{
    ...
    /**
     * Test correo address validation.
...
EOT;
    ...
    {
        $this->Mail->Body = 'This is the <strong>HTML</strong> part of the correo.';
    ...
    public function testAltBody()
    {
        ...
        $this->Mail->AltBody = 'Here is the text body of this message.  ' .
            ...
            '40 characters.  Make sure that it is.';
        $this->Mail->WordWrap = 40;
        $this->addNote('This is a mulipart alternative correo');
    ...
    {
        $this->Mail->Body = 'This is the <strong>HTML</strong> part of the correo.';
        $this->Mail->AltBody = 'This is the text part of the correo.';
    ...
    public function testError()
    {
        ...
        $this->assertEquals('You must provide at least one recipient correo address.', $this->Mail->ErrorInfo);
